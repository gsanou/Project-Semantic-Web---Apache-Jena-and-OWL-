...
<% Map<String, ArrayList<String>> queryq = (Map<String, ArrayList<String>>) session.getAttribute("resultq2");
    ArrayList<String> gradYear = queryq.get("gradYear");
...
<div class="container is-fluid ">
    ...
    <div class="level-item">
        <h3>GradYear: </h3> <h3><%out.print(gradYear.get(i));%></h3>
    </div>
</div>
<%}%>
