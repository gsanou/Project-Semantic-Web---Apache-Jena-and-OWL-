...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        ...
        <a class="nav-link" href="http://localhost/log out.php">Logout</a>
...
<div class="container is-fluid ">
    <div class="level-item">
        <div class="level-item ">
            <form method="POST" action="${pageContext.request.contextPath}/sparql">
                <div class="form-group ">
                    <h5>Enter SPARQL</h5><input style="width:1000px; height: 100px" type="text" class="form-control"  placeholder="" name="sparql" label="sparql" >
